...
A Block defines a peercoin block that provides easier and more efficient
...
A Tx defines a peercoin transaction that provides more efficient manipulation of
...
The Address interface provides an abstraction for a peercoin address.  While the
most common type is a pay-to-pubkey-hash, peercoin already supports others and
